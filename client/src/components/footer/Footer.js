                ...
                <div className="h-[103px] w-full bg-main flex items-center justify-center">
                    <div className="w-main flex items-center justify-between">
                        ...
                        <div className="flex-1 flex items-center">
                            <input className="p-4 pr-0 w-full rounded-l-full bg-[#F04646] outline-none text-gray-100 placeholder:text-sm  placeholder:text-gray-100 placeholder:opacity-50" type="text" placeholder="Email address"/>
                ...
                <div className="h-[407px] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]">
                    <div className="w-main flex ">
                        <div className="flex-2 flex flex-col">
                            ...
                            <span>
                                <span>Address:</span>
                                <span className="opacity-70">ngõ 1,Ao Sen,Hà Đông,Hà Nội</span>
                            </span>
                            <span>
                                <span>Phone:</span>
                            ...
                            <span>
                                <span>Mail:</span>
                                <span className="opacity-70">  tuanpham1ss1@gmail.com</span>
                            </span>
                        </div>
